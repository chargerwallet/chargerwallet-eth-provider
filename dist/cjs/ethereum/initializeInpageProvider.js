 ...
 */
function initializeProvider({ bridge, logger = console, maxEventListeners = 100, shouldSetOnWindow = true, shouldShimWeb3 = false, }) {
    let provider = new MetaMaskInpageProvider_1.default({
        bridge,
        logger,
        maxEventListeners,
    });
    ...
    if (shouldShimWeb3) {
        (0, shimWeb3_1.default)(provider, logger);
    }
    return provider;
}
